"""
Django settings for SearchMethods project.
...
if os.getenv('VERCEL'):
    ...
    # Disable SSL redirect for now until static files work
...
WSGI_APPLICATION = 'SearchMethods.wsgi.application'

ASGI_APPLICATION = 'SearchMethods.asgi.application'
